  ...
  vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function(args)
        vim.api.nvim_create_autocmd('BufEnter', {
          buffer = args.buf,
          callback = function()
            print("Setting autocmds for: " .. lang)
            ...
            map("n", commands.config.keys.run_single, function() commands.run_in_terminal_ask_watch(M.commands[commands.config.run_single_idx]) end, opts) -- Run single
          end,
        })
        -- Exit
        ...
        vim.api.nvim_create_autocmd('BufLeave', {
          buffer = args.buf,
          callback = function()
            print("Clearing autocmds for: " .. lang)
          end,
        })
        -- Save
        vim.api.nvim_create_autocmd('BufWritePre', {
          buffer = args.buf,
          callback = function()
            print("Saving autocmds for: " .. lang)
          end,
        })
    end,
  })
